...
-- 8. towhere_logs 表 - 首页留言/日志
CREATE TABLE IF NOT EXISTS towhere_logs (
...
ALTER TABLE towhere_logs ENABLE ROW LEVEL SECURITY;
...
-- towhere_logs
CREATE POLICY "Allow all access to towhere_logs" ON towhere_logs
    FOR ALL USING (true) WITH CHECK (true);
